...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <?php echo "systemswell.com "; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
	...
	<table cellspacing="0" style="width: 100%;" class="detalle">
		...
		<tr>
            ...
            <td  style="width: 100%; "> 
				...
				<strong>Nombre: </strong> <?php echo (isset($rw_cliente['nombre'])) ? $rw_cliente['nombre'] : '';?><br>
				<strong>Dirección: </strong> <?php echo (isset($rw_cliente['direccion'])) ? $rw_cliente['direccion'] : '';?><br>
				<strong>E-mail: </strong> <?php echo (isset($rw_cliente['email'])) ? $rw_cliente['email'] : '';?><br>
				<strong>Teléfono: </strong> <?php echo (isset($rw_cliente['telefono'])) ? $rw_cliente['telefono'] : '';?>
            </td>
	...
	?>	
	<tr >
		<td colspan=3 class='text-right' style="font-size:24px;color: #3498db">TOTAL COP </td>
